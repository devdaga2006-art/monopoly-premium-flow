          ...
          "@graph": [
            {
              ...
              knowsAbout: [
                ...
                "Plastic granules in Mumbai",
                "Plastic raw material in Mumbai",
                "LDPE HDPE PP raw material",
                "Polymer distribution",
                "Polypropylene (PP) granules",
                "LDPE granules", "LLDPE granules", "HDPE granules",
                "PVC", "PET", "GPPS", "HIPS",
                "ABS", "Polycarbonate (PC)", "Nylon (PA)",
                "POM / Acetal / Delrin", "PMMA / Acrylic", "EVA", "TPR", "TPE",
                "Supplier in Vapi", "Supplier in Vasai", "Supplier in Bhiwandi",
                "Supplier in Daman", "Supplier in Gujarat", "Supplier in Mumbai",
              ],
            },
            {
              "@type": "WebSite",
...
const THEME_INIT_SCRIPT = `(function(){try{var k='monopolymers-theme';var s=localStorage.getItem(k);var m=window.matchMedia&&window.matchMedia('(prefers-color-scheme: dark)').matches;var t=s==='dark'||s==='light'?s:(m?'dark':'light');if(t==='dark'){document.documentElement.classList.add('dark');}}catch(e){}})();`;
