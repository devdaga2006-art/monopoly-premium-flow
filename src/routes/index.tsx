...
function HomePage() {
  ...
  return (
    <>
      {/* HERO */}
      <section className="relative -mt-20 md:-mt-24 min-h-[100svh] flex items-center overflow-hidden">
        <img
          src={heroImg}
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-32 md:py-40 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-6 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.05] text-balance">
              Trusted Polymer Distribution{" "}
              <span className="text-primary">Since 1996.</span>
            </h1>
