        ...
        jsonLd={[
          {
            ...
            address: {
              "@type": "PostalAddress",
              streetAddress: "Gala No. 8, Deewan Indl. Estate, Navghar, Vasai Road",
          ...
          },
          {
            ...
            "@type": "Service",
            "@id": `${url}#service`,
            serviceType: "Plastic raw material & polymer granules distribution",
            name: `Polymer granules supply in ${l.city}`,
            description: l.intro,
            provider: { "@type": "Organization", name: "MONOPOLYMERS", url: SITE },
            areaServed: { "@type": "Place", name: `${l.city}, ${l.region}, India` },
            hasOfferCatalog: {
              "@type": "OfferCatalog",
              name: `Polymer grades supplied in ${l.city}`,
              itemListElement: POLYMERS.map((p) => ({
                "@type": "Offer",
                itemOffered: {
                  "@type": "Product",
                  name: p.fullName,
